...
app.get('/v1.24/_ping', function (req, res) {
...
app.get('/v1.24/version', function (req, res) {
...
app.get('/v1.24/info', function (req, res) {
  res.json({
    Containers: 1,
    Images: 1,
    Driver: 'xcode',
...
// list containers
app.get('/v1.24/containers/json', function (req, res) {
...
app.get('/v1.24/containers/:id/json', function (req, res) {
...
// get container stats
app.get('/v1.24/containers/:id/stats', function (req, res) {
...
// get container details
app.get('/v1.24/containers/:id/top', function (req, res) {
...
// get container logs
app.get('/v1.24/containers/:id/logs', function (req, res) {
...
// delete a container
app.delete('/v1.24/containers/:id', function (req, res) {
...
// create a container
app.post('/v1.24/containers/create', bodyParser.json(), function (req, res) {
...
app.post('/v1.24/containers/:id/wait', function (req, res) {
...
// start a container
app.post('/v1.24/containers/:id/start', bodyParser.json(), function (req, res) {
...
app.post('/v1.24/build', function (req, res) {
...
// inspect an image
app.get('/v1.24/images/:name/json', function (req, res) {
...
// list images
app.get('/v1.24/images/json', function (req, res) {
...
// delete an image
app.delete('/v1.24/images/:name', function (req, res) {
